...
public class DRModEventBusEvents {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(DREntitiyTypes.HEL_WALKER.get(), DraugrEntity.createAttributes().build());
    ...
    public static void commonSetup(FMLCommonSetupEvent event) {
        ...
        SpawnPlacements.register(DREntitiyTypes.HEL_WALKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.WORLD_SURFACE, HelWalkerEntity::canSpawn);
    }
